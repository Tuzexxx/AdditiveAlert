export const translations = {
  cs: {
    ...
    placeholder: 'Vložte složení nebo vyfoťte etiketu na obalu... (např. Voda, cukr, E250, dusitan sodný, kyselina citronová)',
  ...
  en: {
    ...
    placeholder: 'Paste ingredients or snap a photo of the label... (e.g. Water, sugar, E250, sodium nitrite, citric acid)',
  ...
  de: {
    ...
    placeholder: 'Zutaten einfügen oder Etikett fotografieren... (z. B. Wasser, Zucker, E250, Natriumnitrit, Zitronensäure)',
